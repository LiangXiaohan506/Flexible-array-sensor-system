...
uint16 SSIZE[MAX_SOCK_NUM]={0,8,0,0,0,0,0,0}; // Max Tx buffer
uint16 RSIZE[MAX_SOCK_NUM]={0,8,0,0,0,0,0,0}; // Max Rx buffer
uint8 txsize[MAX_SOCK_NUM] = {0,8,0,0,0,0,0,0};//tx buffer set	K bits
uint8 rxsize[MAX_SOCK_NUM] = {0,8,0,0,0,0,0,0};//rx buffet set  K bits
